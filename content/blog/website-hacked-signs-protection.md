...
tldr:
  - "7 סימנים שאתר נפרץ: תוכן שהשתנה, דיווחי משתמשים על פרסומות וחלונות קופצים, ירידה חדה בביצועים, אזהרות גוגל, בעיות בתעודת SSL, אובדן גישה לממשק הניהול, ועסקאות חשודות."
  - "96.2% מאתרי CMS שנפרצו ב-2024 היו וורדפרס (Sucuri), ו-96% מהפרצות בוורדפרס מקורן בתוספים (Patchstack, 2025)."
  - "מניעה עולה 70-400 ₪ לחודש; תיקון אחרי פריצה עולה 20,000-50,000 ₪ לאירוע."
  - "אם האתר נפרץ: לא למחוק כלום, לגבות הכל, לפנות לחברת האחסון ולמומחה אבטחה. ניקוי מקצועי עולה 2,000-10,000 ₪."
faq:
  - question: "איך יודעים אם אתר נפרץ?"
    answer: "יש 7 סימנים עיקריים: תוכן או דפים שהשתנו ללא ידיעתכם, דיווחי לקוחות על חלונות קופצים ופרסומות זרות, ירידה דרמטית במהירות האתר, אזהרות של גוגל (״אתר זה עלול לפגוע במחשב שלך״), תעודת SSL לא תקפה בפתאומיות, סיסמת ניהול שהפסיקה לעבוד, וחיובים או עסקאות שלא אישרתם."
  - question: "מה עושים אם האתר נפרץ?"
    answer: "קודם כל לא למחוק כלום ולא לנסות לתקן לבד: זה עלול למחוק ראיות ולגרום נזק נוסף. יש לגבות את האתר כמו שהוא (כולל הקוד הזדוני), ליצור קשר מיידי עם חברת האחסון, מפתח האתר ומעבד התשלומים אם יש חנות, ולפנות למומחה אבטחה לניקוי, חקירה והחלפת כל הסיסמאות."
  - question: "כמה עולה לתקן אתר שנפרץ?"
    answer: "ניקוי מקצועי של אתר נפרץ עולה בממוצע 2,000-10,000 ₪, אבל העלות הכוללת של אירוע פריצה, כולל שחזור נתונים, נזק למוניטין ופגיעה בלקוחות, מגיעה ל-20,000-50,000 ₪. לשם השוואה, מניעה מלאה (גיבויים, עדכונים, חומת אש וניטור) עולה 70-400 ₪ לחודש בלבד."
  - question: "למה האקרים תוקפים אתרים של עסקים קטנים?"
    answer: "כי רוב המתקפות אוטומטיות: רובוטים סורקים אלפי אתרים ביום ומחפשים חולשות, ואתרים קטנים בדרך כלל פחות מאובטחים. המטרות: גניבת פרטי כרטיסי אשראי, איסוף סיסמאות, השתלת תוכנות זדוניות, שליחת ספאם מהשרת, כופר ודיוג. ב-2025 נמצאו 11,334 פרצות אבטחה חדשות בוורדפרס (Patchstack)."
  - question: "איך מגינים על אתר מפני פריצה?"
    answer: "שבעה צעדים: גיבויים יומיים אוטומטיים במקום נפרד (20-100 ₪ לחודש), עדכון שוטף של וורדפרס ותוספים, סיסמאות של 16+ תווים עם מנהל סיסמאות, חומת אש WAF כמו Cloudflare (חינם עד 100 ₪), סריקות malware חודשיות, תעודת SSL חינמית מ-Let's Encrypt, והרשאות מוגבלות עם אימות דו-שלבי. הכל יחד פחות מ-400 ₪ לחודש."
sources:
  - title: "Patchstack — State of WordPress Security 2025 (11,334 פרצות חדשות; 96% מהפרצות בתוספים)"
    url: "https://patchstack.com/"
  - title: "Sucuri — Hacked Website Threat Report 2024 (96.2% מאתרי CMS שנפרצו היו וורדפרס)"
    url: "https://sucuri.net/"
  - title: "SSL Insights/GlobalSign — SSL Usage Statistics 2025 (88% מהאתרים ב-HTTPS)"
...
רבים חושבים שהאקרים מתעניינים רק באתרים גדולים, אבל המציאות שונה לחלוטין. **אתרים קטנים ובינוניים הם יעדים מועדפים** כי הם פחות מאובטחים. ב-2025 נמצאו 11,334 פרצות אבטחה חדשות בוורדפרס (מקור: Patchstack, 2025), ו-96.2% מאתרי CMS שנפרצו ב-2024 היו וורדפרס (מקור: Sucuri, 2024).
...
> **💡 דוגמה מהפרויקטים שלי:** אתרים שבניתי ב-Next.js (כמו [Lola Martin](https://lolamartin.co.il) ו-[Shepes Group](https://www.shepes-group.co.il)) לא נפרצו מעולם. למה? אין WordPress, אין תוספים פגיעים, אין מסד נתונים חשוף. זה אחד היתרונות של [בניית אתר מאובטח לעסק](/services/web-development) מהיסוד: הארכיטקטורה המודרנית פשוט יותר מאובטחת.
...
**למה זה חשוב:** 96% מהפרצות בוורדפרס מקורן בתוספים (מקור: Patchstack, 2025), ו-35% מפרצות וורדפרס ב-2024 נותרו ללא תיקון (מקור: Patchstack, 2025). עדכונים שוטפים הם קו ההגנה הראשון.
...
- **חובה לכל אתר** - גם אם לא מוכרים כלום. 88% מהאתרים כבר משתמשים ב-HTTPS, ו-85% מהגולשים מרגישים בטוחים יותר באתר עם SSL (מקור: SSL Insights/GlobalSign, 2025)
...
| נתון | מקור |
|------|------|
| ב-2025 נמצאו 11,334 פרצות אבטחה חדשות בוורדפרס | Patchstack, State of WordPress Security, 2025 |
| 96.2% מאתרי CMS שנפרצו ב-2024 היו וורדפרס | Sucuri, Hacked Website Threat Report, 2024 |
| 96% מהפרצות מקורן בתוספים | Patchstack, State of WordPress Security, 2025 |
| 35% מפרצות וורדפרס ב-2024 נותרו ללא תיקון | Patchstack, State of WordPress Security, 2025 |
| 88% מהאתרים משתמשים ב-HTTPS. 85% מהגולשים מרגישים בטוחים יותר באתר עם SSL | SSL Insights/GlobalSign, SSL Usage Statistics, 2025 |
