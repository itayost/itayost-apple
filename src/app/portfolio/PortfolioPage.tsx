      ...
      <section className="py-8 sticky top-16 lg:top-20 bg-white z-30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="sm:hidden overflow-x-auto -mx-4 scrollbar-hide" style={{ WebkitOverflowScrolling: 'touch', scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
            <div className="flex gap-2 p-1 bg-brand-gray-100 rounded-full mx-4 pr-4" style={{ width: 'max-content' }}>
              {categories.map((category) => (
                <motion.button
                  key={category.id}
                  onClick={() => setSelectedCategory(category.id)}
              ...
              return (
                ...
                >
                  <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2">
                    ...
                    <div className="relative h-64 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                      ...
                      {project.link && (
                        <div className="absolute top-4 left-4">
                          <span className="px-3 py-1 bg-brand-green text-white rounded-full text-xs font-medium flex items-center gap-1">
                    ...
                    {/* Content */}
                    <div className="p-6">
                      <h3 className="text-xl font-bold text-brand-gray-900 mb-2 group-hover:text-brand-purple transition-colors">
                        {project.title}
                      </h3>
                      
                      <p className="text-brand-gray-600 mb-4 text-sm">
                        {project.description}
                      </p>
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        ...
                        {project.tags.length > 3 && (
                          <span className="px-2 py-1 text-xs text-brand-gray-500">
                            +{project.tags.length - 3}
                          </span>
                        )}
                      </div>
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <ArrowUpRight size={20} className="text-brand-purple group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
                      </div>
                    </div>
                  </div>
                </motion.article>
        ...
        >
          ...
          >
            ...
            <div className="sticky top-0 bg-white border-b p-6 flex items-center justify-between rounded-t-3xl">
              ...
              <button
                onClick={() => setSelectedProject(null)}
                className="w-10 h-10 rounded-full bg-brand-gray-100 flex items-center justify-center hover:bg-brand-gray-200 transition-colors"
              >
                <X size={20} />
              </button>
            </div>
            ...
            <div className="p-6 lg:p-8">
              ...
              {selectedProject.image && (
                <div className="mb-8 rounded-xl overflow-hidden bg-brand-gray-100">
                  <img 
              ...
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                <div>
                  <div className="mb-6">
                    ...
                    <p className="text-brand-gray-600">{selectedProject.longDescription}</p>
                  </div>
                    ...
                    <ul className="space-y-2">
                      {selectedProject.features.map((feature, idx) => (
                        <li key={idx} className="flex items-start gap-2">
                          <CheckCircle className="text-brand-green mt-0.5" size={16} />
                ...
                <div>
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      {selectedProject.results.map((result, idx) => (
                        <div key={idx} className="bg-brand-gray-50 rounded-xl p-4">
                  ...
                  {selectedProject.testimonial && (
                    <div className="mb-6">
                      ...
                      <blockquote className="bg-brand-purple/10 rounded-xl p-6">
                        <p className="text-brand-gray-700 italic mb-4">
                  ...
                  <div className="flex gap-4">
                    {selectedProject.link ? (
                      <a
                        ...
                        className="flex-1 py-3 bg-brand-purple text-white text-center rounded-xl font-medium hover:bg-brand-purple/90 transition-colors flex items-center justify-center gap-2"
                      >
                        צפייה באתר
                        <ExternalLink size={18} />
                      </a>
                    ) : (
                      <div className="flex-1 py-3 bg-brand-gray-200 text-brand-gray-500 text-center rounded-xl font-medium cursor-not-allowed">
                        פרויקט פרטי
                      </div>
                    )}
                    <Link
                      href="/contact"
                      className="flex-1 py-3 bg-brand-gray-100 text-brand-gray-900 text-center rounded-xl font-medium hover:bg-brand-gray-200 transition-colors"
                    >
                      בואו נדבר
                    </Link>
                  </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <div className="text-sm text-brand-gray-600 mt-2">
                  {stat.label}
                </div>
              </motion.div>
            ))}
      ...
      <section className="py-16 lg:py-24 bg-gradient-to-r from-brand-purple to-brand-pink">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="px-8 py-4 bg-white text-brand-purple rounded-full font-medium hover:shadow-xl transition-all"
            >
              בואו נתחיל
            </Link>
            <Link
