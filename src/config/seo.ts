    ...
    faqPage: {
      ...
      mainEntity: [
        // General & Pricing
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'המחיר תלוי בסוג האתר ובמורכבות. אתר תדמית בסיסי: 8,000-15,000 ש"ח. אתר עסקי מתקדם עם ניהול תוכן: 15,000-25,000 ש"ח. חנות אונליין: 20,000-35,000 ש"ח. מערכת CRM או פורטל לקוחות: 25,000-50,000 ש"ח. המחיר כולל עיצוב, פיתוח, העלאה לאוויר ואחריות. אפשר תשלום במספר תשלומים.',
          },
        },
        {
          '@type': 'Question',
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'המחיר כולל: אפיון מלא של הפרויקט, עיצוב UI/UX מותאם אישית, פיתוח רספונסיבי (מתאים לכל המכשירים), אופטימיזציה למנועי חיפוש (SEO), העלאה לאוויר והדרכה, 6 חודשי אחריות לתקלות, חודש תמיכה חינם. לא כלול: דומיין ושרת (30-100 ש"ח לחודש), תוכן ותמונות (אם דרוש כתיבה מקצועית), שירותי שיווק ופרסום.',
          },
        },
        {
          '@type': 'Question',
          name: 'האם אפשר תשלום בתשלומים?',
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'כן! אני מבין שפרויקט דיגיטלי הוא השקעה. אפשר לפרוס את התשלום: לפרויקטים עד 20,000 ש"ח - עד 3 תשלומים. לפרויקטים גדולים יותר - עד 6 תשלומים. בדרך כלל: 30% מקדמה, 40% באמצע הפיתוח, 30% במסירה. אפשרויות תשלום: העברה בנקאית, אשראי, Bit, PayBox.',
          },
        },
