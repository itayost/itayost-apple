...
export const seoConfig = {
  ...
  pages: {
    ...
    about: {
      ...
      description: 'הכירו את איתי אוסטרייך, מפתח עצמאי עם למעלה מ-5 שנות ניסיון ומעל 100 פרויקטים. בונה מערכות, אוטומציות ואתרים לעסקים קטנים ובינוניים.',
    ...
    'ecommerce': {
      ...
      description: 'בניית חנויות אונליין מותאמות עם Bit, PayBox, Tranzila. ניהול מלאי, משלוחים, קופונים, דוחות. שליטה מלאה והקוד בבעלותך. קבל הצעת מחיר מותאמת.',
    ...
    'crm-systems': {
      ...
      keywords: [
        'מערכת CRM',
        'בניית מערכת CRM',
        'בניית מערכת CRM לפי הזמנה',
        'בניית מערכת CRM מותאמת אישית',
        'CRM מותאם אישית',
        'CRM לפי הזמנה',
        'מערכת CRM לעסקים',
        ...
        'CRM בעברית',
        'CRM לעסקים בישראל',
        'בניית מערכת CRM מחיר',
        'בניית מערכת CRM עלות',
      ],
