...
export const content = {
  ...
  hero: {
    title: {
      line1: 'שיווק דיגיטלי',
      line2: 'שמביא לקוחות אמיתיים',
      line3: 'לעסק שלך',
    },
    subtitle: 'עוזרים לעסקים קטנים בישראל להופיע באינטרנט, למשוך לקוחות ולגדול — בלי תקציבי ענק',
    cta: {
      primary: 'קבל ייעוץ חינם',
      secondary: 'ראה את השירותים שלנו',
    },
  },
  ...
  about: {
    ...
    intro: {
      title: 'איתי אוסטרייך',
      role: 'בונה מערכות ואתרים לעסקים',
      description: 'עוזר לבעלי עסקים להפסיק לבזבז שעות על ניהול ידני ולהתחיל להביא יותר לקוחות.',
    },
    mission: {
      title: 'החזון שלי',
      description: 'שטכנולוגיה תעבוד בשבילכם, לא להיפך. בלי ז\'רגון, בלי הפתעות, רק פתרונות שעובדים.',
    },
    story: {
      title: 'קצת עליי',
    ...
    values: {
      ...
      items: [
        ...
        },
        {
          icon: '⚡',
          title: 'עומד במילה',
          description: 'לוח זמנים ומחיר סגורים מראש. אם יש שינוי תדעו על כך מראש.',
        },
        {
          icon: '💰',
    ...
    cta: {
      title: 'רוצים לשמוע מה אפשר לעשות לעסק שלכם?',
      subtitle: 'שיחה קצרה בלי התחייבות ואני אגיד לכם אם ואיך אפשר לעזור',
      button: 'בואו נדבר',
    },
  },
  ...
  contact: {
    ...
    form: {
      ...
      message: {
        label: 'הודעה',
        placeholder: 'ספרו לי קצת על העסק ומה הייתם רוצים לשפר...',
      },
      submit: 'שלח הודעה',
      sending: 'שולח...',
