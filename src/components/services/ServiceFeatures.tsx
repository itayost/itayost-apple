        ...
        >
          {features.map((feature, index) => (
            <motion.div
              key={index}
              variants={item}
              className="group relative overflow-hidden rounded-2xl border border-apple-gray-200 bg-white p-8 shadow-sm transition-all hover:shadow-xl"
            >
              ...
              <div className="relative">
                {/* Icon */}
                <div className="mb-4 inline-flex h-16 w-16 items-center justify-center rounded-xl bg-apple-gray-50 text-3xl transition-transform group-hover:scale-110">
                  {feature.icon}
                </div>
