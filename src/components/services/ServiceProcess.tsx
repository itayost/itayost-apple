...
export default function ServiceProcess({ process, gradient }: ServiceProcessProps) {
  return (
    <section className="bg-apple-gray-50 py-20 lg:py-24">
      <div className="container mx-auto px-4">
        ...
        <div className="mx-auto max-w-4xl">
          <div className="relative">
            ...
            <div
              className="absolute right-8 top-0 h-full w-0.5 bg-apple-gray-200 sm:right-12"
              aria-hidden="true"
            />
            ...
            <div className="space-y-12">
              {process.map((step, index) => (
                ...
                >
                  ...
                  {/* Content card */}
                  <div className="mr-24 rounded-2xl border border-apple-gray-200 bg-white p-6 shadow-sm transition-shadow hover:shadow-md sm:mr-28 sm:p-8">
                    <div className="flex flex-col gap-3">
                      {/* Title and duration */}
                      <div className="flex items-start justify-between gap-4">
                        <h3 className="text-xl font-bold text-apple-gray-900 sm:text-2xl">
                          {step.title}
                        </h3>
                        {step.duration && (
                          <span className="shrink-0 rounded-full bg-apple-gray-100 px-3 py-1 text-sm font-medium text-apple-gray-700">
                            {step.duration}
                          </span>
                        )}
                      </div>
