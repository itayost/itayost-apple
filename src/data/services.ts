    ...
    faq: [
      {
        ...
        answer: 'התמחור מורכב משני רכיבים: עלות הקמה חד פעמית (₪15,000-25,000 למערכת בסיסית, ₪25,000-50,000 למערכת מתקדמת עם אוטומציות ואינטגרציות) + דמי ניהול חודשיים קבועים שמכסים אחסון, גיבויים, תמיכה ותחזוקה. לעומת Salesforce (~₪150-300 למשתמש לחודש) או Monday/HubSpot (~₪50-150 למשתמש לחודש) - אצלי דמי הניהול הם מחיר אחד שלא משלמים פר משתמש, כך שהעלות לא גדלה ככל שהצוות מתרחב. הצעת מחיר מדויקת תוך 24 שעות.'
      },
      {
      ...
      },
      {
        ...
        answer: 'התמחור עובד בשני רכיבים: (1) עלות הקמה חד פעמית בפיתוח המערכת לפי דרישות הפרויקט. (2) דמי ניהול חודשיים קבועים שמכסים אחסון בשרתים מאובטחים, גיבויים יומיים, תמיכה שוטפת, תחזוקה ושינויים קלים. בניגוד ל-Monday/HubSpot/Salesforce, דמי הניהול הם מחיר קבוע שלא תלוי בכמות המשתמשים - 1 איש או 50 איש משלמים אותו דבר. הקוד והנתונים בבעלותך לאורך כל הדרך.'
      },
      {
      ...
      },
      {
        ...
        answer: 'בהחלט! זה היופי של מערכת מותאמת. אפשר להוסיף תכונות, לשנות תהליכים, להתאים למבנה הארגון. כל שינוי מתומחר בנפרד או דרך חבילת תמיכה חודשית.'
      },
      {
      ...
      },
      {
        ...
        answer: 'ממשק אינטואיטיבי לא דורש הרבה הדרכה. מספק הדרכה מקיפה בהשקה + מדריכי וידאו + תמיכה שוטפת בשבועיים הראשונים.'
      }
    ],
    cta: {
    ...
    faq: [
      {
        ...
        answer: 'אפליקציה פשוטה (MVP) מ-₪15,000 עד ₪35,000, אפליקציה בינונית ₪35,000-70,000, ואפליקציה מורכבת ₪70,000-150,000+. אפליקציה אחת ל-iOS ולאנדרואיד חוסכת 40-50% לעומת שני פיתוחים נפרדים. הצעת מחיר מדויקת תוך 24 שעות.'
      },
      {
