...
export const servicesData: Service[] = [
  {
    ...
    process: [
      ...
      },
      {
        step: 6,
        title: 'השקה',
        description: 'העלאה לאוויר והדרכה. אחריות 6 חודשים',
        duration: 'יום אחד'
      }
    ],
    ...
    faq: [
      ...
      },
      {
        ...
        answer: 'אפיון, עיצוב UI/UX, פיתוח, SEO, העלאה, הדרכה ו-6 חודשי אחריות.'
      },
      {
...

  {
    id: 'crm-systems',
    slug: 'crm-systems',
    name: 'בניית מערכת CRM מותאמת אישית',
    tagline: 'CRM מותאם לעסק — בעברית מלאה, ללא עמלת מושב לכל משתמש',
    description: 'בניית מערכת CRM מותאמת אישית לניהול לקוחות, עסקאות, משימות ואוטומציה. עברית מלאה, חיבור ישיר למפתח, ללא עמלת מושב לכל משתמש.',
    longDescription: 'בניית מערכת CRM מותאמת אישית היא לב העסק. לפי Nucleus Research, CRM מחזיר $8.71 על כל דולר שמושקע. עסקים עם CRM רואים עלייה של 29% במכירות ו-34% בפרודוקטיביות (Salesforce, 2024). במקום להסתדר עם פתרונות גנריים כמו HubSpot או Salesforce (47-55% מהטמעות CRM נכשלות לפי Forrester, בעיקר בגלל חוסר התאמה ועמלות מושב חודשיות שגדלות עם הצוות), אני בונה מערכות CRM לפי הזמנה שמתאימות בדיוק לתהליכי העבודה שלך. ניהול לידים, מעקב אחר עסקאות, אוטומציות, תזכורות, דוחות - הכל במקום אחד, בעברית, ב-RTL. המערכת משתלבת עם הכלים הקיימים שלך (דואר, לוח שנה, WhatsApp Business, מערכות הנהלת חשבונות בישראליות) ונגישה מכל מכשיר. תמחור ברור: עלות הקמה חד פעמית בפיתוח + דמי ניהול חודשיים קבועים שמכסים אחסון, גיבויים ותחזוקה - בלי לקנות מושב לכל משתמש כמו ב-Monday/HubSpot, כך שהעלות לא גדלה כשהצוות מתרחב. הקוד והנתונים שלך, ללא תלות בספק, מתאים לעסקים בישראל שמחפשים פתרון CRM בעברית עם הטמעה צמודה.',
    icon: '📊',
    ...
    faq: [
      {
        question: 'כמה עולה לבנות מערכת CRM מותאמת אישית?',
        answer: 'התמחור מורכב משני רכיבים: עלות הקמה חד פעמית, שנקבעת לפי היקף המערכת - כמה מסכים, אילו אוטומציות ואילו אינטגרציות - ודמי ניהול חודשיים קבועים שמכסים אחסון, גיבויים ותחזוקה. בניגוד למערכות מוכנות שגובות לכל משתמש, דמי הניהול כאן הם מחיר אחד שלא גדל ככל שהצוות מתרחב. הצעת מחיר מדויקת תוך 24 שעות.'
      },
      {
        question: 'מה ההבדל בין CRM מותאם אישית לבין Monday/HubSpot/Salesforce?',
        answer: 'מערכות מוכנות (Monday, HubSpot, Salesforce) הן גנריות, מבוססות עמלה לכל משתמש שגדלה עם הצוות, ולא תמיד מתאימות לתהליכי העבודה שלך. מערכת CRM מותאמת אישית נבנית בדיוק לפי התהליכים שלך, בעברית מלאה ו-RTL, ללא עמלת מושב פר משתמש, ועם הקוד והנתונים בבעלותך. אנא קראו את ההשוואה המלאה בבלוג.'
      },
      {
        question: 'איך עובד התמחור? יש מנוי חודשי?',
        answer: 'התמחור עובד בשני רכיבים: (1) עלות הקמה חד פעמית בפיתוח המערכת לפי דרישות הפרויקט. (2) דמי ניהול חודשיים קבועים שמכסים אחסון בשרתים מאובטחים, גיבויים יומיים, תחזוקה ושינויים קלים. בניגוד ל-Monday/HubSpot/Salesforce, דמי הניהול הם מחיר קבוע שלא תלוי בכמות המשתמשים - 1 איש או 50 איש משלמים אותו דבר. הקוד והנתונים בבעלותך לאורך כל הדרך.'
      },
      {
      ...
      {
        question: 'האם המערכת תומכת בעברית ו-RTL מלא?',
        answer: 'בהחלט. כל המערכות שאני בונה תומכות בעברית מלאה (ממשק, נתונים, חיפוש, דוחות) ו-RTL מובנה - לא תוסף או הוספה מאוחרת. גם הודעות מערכת, מיילים אוטומטיים והתראות במובייל - הכל בעברית.'
      },
      {
        question: 'איך עובדת האינטגרציה עם Gmail, WhatsApp ומערכות הנהלת חשבונות?',
        answer: 'המערכת מתחברת ישירות ל-Gmail/Outlook (כל התכתבות נשמרת אוטומטית), WhatsApp Business (שליחת הודעות, מעקב), Google Calendar/Outlook Calendar, ומערכות חשבוניות בישראליות (חשבונית ירוקה, iCount, Greeninvoice). אוטומציות לחשבוניות, תזכורות תשלום, מעקב לקוחות - הכל אוטומטי.'
      },
      {
        question: 'האם אפשר להוסיף תכונות אחרי ההשקה?',
        answer: 'בהחלט! זה היופי של מערכת מותאמת. אפשר להוסיף תכונות, לשנות תהליכים, להתאים למבנה הארגון. כל שינוי מתומחר בנפרד או דרך חבילת התחזוקה החודשית.'
      },
      {
        question: 'מה קורה עם הנתונים שלי?',
        answer: 'הנתונים שלך שייכים לך בלבד. מאוחסנים בשרתים מאובטחים בישראל או באירופה (GDPR-compliant). גיבויים יומיים אוטומטיים. ניתן לייצא את כל הנתונים בכל רגע ל-CSV/JSON.'
      },
      {
        question: 'האם הצוות שלי יצטרך הדרכה?',
        answer: 'ממשק אינטואיטיבי לא דורש הרבה הדרכה. מספק הדרכה מקיפה בהשקה ומדריכי וידאו.'
      }
    ],
    cta: {
...

  {
    ...
    portfolio: ['9'], // Amit EyeBrows - WhatsApp automation
    faq: [
      {
      ...
      },
      {
        ...
        answer: 'המערכת שולחת התראות על תקלות, כך שהן מטופלות מוקדם.'
      },
      {
    ...
    faq: [
      {
        ...
        answer: 'המחיר נקבע לפי היקף האפליקציה: מספר המסכים, התחברות משתמשים, תשלומים, התראות ואינטגרציות. אפליקציה אחת שרצה גם ב-iOS וגם באנדרואיד חוסכת לעומת שני פיתוחים נפרדים. הצעת מחיר מדויקת תוך 24 שעות.'
      },
      {
      ...
      {
        question: 'מה כלול במחיר?',
        answer: 'אפיון, עיצוב UI/UX, פיתוח (iOS + Android), Backend, בדיקות והעלאה לחנויות.'
      },
      {
